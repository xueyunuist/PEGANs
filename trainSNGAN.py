...
from models import resnet, dcgan, biggan, SAdcgan,sngan
...
net_G_models = {
    ...
    'sadcgan.48': SAdcgan.Generator48,
    'sngan.32': sngan.Generator32,
}
...
net_D_models = {
    ...
    'sadcgan.48': SAdcgan.Discriminator48,
    'sngan.32': sngan.Discriminator32,
}
...
datasets = ['cifar10.32', 'stl10.48', 'cat.128', 'celeba.64']
...
flags.DEFINE_string('fid_stats', './stats/cifar10.test', 'FID cache')
flags.DEFINE_string('logdir', './logs/SNGAN_CNN_CIFAR10', 'log folder')
flags.DEFINE_string('des', 'thieis', 'describe')
